...
function Hit(hit: any) {
    return <ProductCard key={hit.hit.objectID} id={parseInt(hit.hit.objectID)} title={hit.hit.name} price={hit.hit.price} categories={hit.hit.categories} shouldBeAbleToDelete={false} />
}
